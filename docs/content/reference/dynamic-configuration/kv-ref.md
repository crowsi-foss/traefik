...
| `traefik/tcp/middlewares/TCPMiddleware01/accessLog/bufferingSize` | `42` |
| `traefik/tcp/middlewares/TCPMiddleware01/accessLog/fields/defaultMode` | `foobar` |
| `traefik/tcp/middlewares/TCPMiddleware01/accessLog/fields/names/name0` | `foobar` |
| `traefik/tcp/middlewares/TCPMiddleware01/accessLog/fields/names/name1` | `foobar` |
| `traefik/tcp/middlewares/TCPMiddleware01/accessLog/filePath` | `foobar` |
| `traefik/tcp/middlewares/TCPMiddleware01/accessLog/filters/minDuration` | `42s` |
| `traefik/tcp/middlewares/TCPMiddleware01/accessLog/filters/requireTLS` | `true` |
| `traefik/tcp/middlewares/TCPMiddleware01/accessLog/format` | `foobar` |
